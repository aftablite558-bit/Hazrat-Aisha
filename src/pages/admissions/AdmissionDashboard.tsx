                ...
                <tbody className="divide-y divide-line">
                  {applications.length === 0 ? (
                    ...
                    applications.map((app) => (
                      <tr key={app.id} className="bg-surface hover:bg-surface-raised transition-colors duration-fast">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end gap-1.5">
                            {app.status === 'pending' && (
                              <>
                                <Button variant="secondary" size="sm" onClick={() => handleStatusChange(app.id, 'approved')} className="text-success-500 hover:text-success-600 border-line hover:bg-success-500/5">
                                  <CheckCircle className="h-4 w-4" />
                                </Button>
                                <Button variant="secondary" size="sm" onClick={() => handleStatusChange(app.id, 'rejected')} className="text-danger-500 hover:text-danger-600 border-line hover:bg-danger-500/5">
                                  <XCircle className="h-4 w-4" />
                                </Button>
                              </>
                            )}
                            <Button variant="secondary" size="sm" className="border-line text-content-secondary hover:text-content">
