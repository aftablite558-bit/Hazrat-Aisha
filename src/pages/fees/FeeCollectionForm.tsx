      ...
      <div className="flex gap-4 mb-6">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 p-2 border border-[var(--border-default)] rounded-[var(--radius-sm)] bg-[var(--bg-surface)] text-sm text-content transition-all focus:outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(52,245,197,0.18)]"
          />
        </div>
          ...
          <CardContent className="p-0">
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-line">
                {students.map(s => (
                  <tr key={s.id} className="bg-surface hover:bg-surface-raised transition-colors duration-fast">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Button size="sm" variant="secondary" onClick={() => loadStudentData(s)} className="border-line text-content-secondary hover:text-content font-bold font-display">Select</Button>
                    </td>
                  </tr>
                ))}
              </tbody>
            ...
            <Card className="border-line shadow-e1">
              <CardHeader className="border-b border-line pb-4 font-display">
                <div className="flex justify-between items-center">
                  ...
                  <Button variant="secondary" size="sm" onClick={() => setSelectedStudent(null)} className="border-line text-content-secondary hover:text-content font-bold font-display">Back to Search</Button>
                </div>
              </CardHeader>
                        ...
                        <div 
                          ...
                          className={`p-4 border rounded-xl cursor-pointer transition-all duration-fast ${
                            selectedInvoice?.id === inv.id 
                              ...
                              : 'border-line hover:border-content-tertiary bg-surface-raised'
                          }`} 
                ...
                {receipts.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                      ...
                      <tbody className="divide-y divide-line">
                        {receipts.map(r => (
                          <tr key={r.id} className="bg-surface hover:bg-surface-raised transition-colors duration-fast">
                            ...
                            <td className="px-6 py-4 text-right">
                              <Button size="sm" variant="ghost" className="hover:bg-surface-overlay text-content-secondary hover:text-content">
          ...
          <div>
            <Card className="border-line shadow-e1">
              ...
              <CardContent className="space-y-4 pt-6">
                <div className="p-4 bg-surface-raised border border-line rounded-xl font-display">
                ...
                {selectedInvoice ? (
                  ...
                  <div className="py-12 text-center text-content-tertiary font-semibold border-2 border-dashed border-line rounded-xl font-display">
