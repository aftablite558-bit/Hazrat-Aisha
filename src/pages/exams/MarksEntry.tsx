    ...
    <div className="space-y-6 font-body">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => navigate(`/exams/${id}/publish`)} className="border-line text-content-secondary hover:text-content font-bold font-display">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <Card className="w-full lg:w-64 shrink-0 border-line shadow-e1 overflow-hidden">
                ...
                <button
                  ...
                  className={`text-left px-4 py-3 text-sm font-semibold transition-all duration-fast border-l-4
                    ${activeSubject === sub.id 
                      ...
                      : 'border-transparent hover:bg-surface-raised text-content-secondary hover:text-content'
                    }`}
                >
                  {sub.name}
        ...
        {/* Marks Entry Table */}
        <Card className="flex-1 border-line shadow-e1">
                ...
                <table className="w-full text-sm text-left min-w-[800px]">
                  ...
                  <tbody className="divide-y divide-line">
                    {students.map((student) => {
                      ...
                      return (
                        <tr key={student.id} className="bg-surface hover:bg-surface-raised transition-colors duration-fast">
                          ...
                          <td className="px-6 py-4">
                            <input
                              ...
                              className={`w-full p-2 border rounded-[var(--radius-sm)] bg-[var(--bg-surface)] text-sm text-content transition-all focus:outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(52,245,197,0.18)]
