...
export function ResultPortal() {
  ...
  return (
    <div className="bg-[var(--bg-surface-raised)] min-h-screen w-full py-12 px-4 sm:px-6 lg:px-8 font-body">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="w-full sm:w-1/2">
                  ...
                  <select
                    ...
                    className="w-full p-2.5 sm:p-3 border border-[var(--border-default)] rounded-[var(--radius-sm)] bg-[var(--bg-surface)] text-sm text-content transition-all focus:outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(52,245,197,0.18)]"
                  >
                ...
                <div className="w-full sm:w-1/2 flex gap-2 sm:gap-4 items-end">
                  ...
                  <Button type="submit" size="icon" disabled={loading} className="shrink-0 h-[46px] w-[46px] sm:h-[50px] sm:w-[50px] font-bold font-display shadow-sm">
